document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
            ...
            if (isValid) {
                ...
                xhr.onload = function() {
                    ...
                    if (xhr.status >= 200 && xhr.status < 300) {
                        showFormMessage(contactForm, 'success', 'Message sent successfully!');
                        contactForm.reset();
                    } else {
                        showFormMessage(contactForm, 'error', 'Something went wrong. Please try again.');
                    }
                };
                ...
                xhr.onerror = function() {
                    ...
                    showFormMessage(contactForm, 'error', 'Network error. Please check your connection.');
                };
        ...
        function validateField(field) {
            ...
            if (!errorMessage && field.hasAttribute('minlength') && value !== '') {
            ...
            if (!errorMessage && field.hasAttribute('pattern') && value !== '') {
        ...
        function showFormMessage(form, type, message) {
            ...
            msgEl.style.cssText = 'padding: 12px 16px; margin-top: 16px; border-radius: 4px; font-size: 0.95rem;';
    ...
    var animatedElements = document.querySelectorAll('.fade-in, .fade-in-up, .fade-in-left, .fade-in-right, .animate-on-scroll');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9f29208d-4bdc-4557-b79e-92bf60712ace',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9f29208d-4bdc-4557-b79e-92bf60712ace';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9f29208d-4bdc-4557-b79e-92bf60712ace';
